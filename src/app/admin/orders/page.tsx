                        ...
                        <tbody>
                            {orders.map((order) => (
                                <tr
                                    ...
                                    style={{ borderBottom: '1px solid var(--border-color)', transition: 'var(--transition-fast)', cursor: 'pointer' }}
                                ...
                                >
                                    ...
                                    <td style={{ padding: '1.25rem 1.5rem', textAlign: 'right', color: 'var(--text-secondary)' }}>
